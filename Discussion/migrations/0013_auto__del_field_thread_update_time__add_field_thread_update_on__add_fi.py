...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Thread.update_by'
        db.add_column('Discussion_thread', 'update_by',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Thread.update_by'
        db.delete_column('Discussion_thread', 'update_by_id')
    ...
    models = {
        ...
        'Discussion.thread': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['Discussion.ThreadCategory']", 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'update_by': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['KFLProduct.UserProfile']", 'blank': 'True'}),
        ...
        'Discussion.threadcontent': {
            ...
            'posted_by': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['KFLProduct.UserProfile']", 'blank': 'True', 'related_name': "'p_by'"}),
            'posted_on': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'related_thread': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'to': "orm['Discussion.ThreadContent']", 'blank': 'True', 'related_name': "'related_thread_rel_+'"}),
            'replied_by': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['KFLProduct.UserProfile']", 'blank': 'True', 'related_name': "'r_by'"}),
        ...
        'KFLProduct.userprofile': {
            ...
            'last_viewed_product': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'symmetrical': 'False', 'to': "orm['KFLProduct.DVDProduct']", 'blank': 'True', 'related_name': "'v_product'"}),
            'purchased_product': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'symmetrical': 'False', 'to': "orm['KFLProduct.DVDProduct']", 'blank': 'True', 'related_name': "'p_product'"}),
