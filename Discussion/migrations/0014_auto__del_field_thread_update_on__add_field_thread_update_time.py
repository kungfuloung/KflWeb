...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'Discussion.threadcontent': {
            ...
            'master_content': ('django.db.models.fields.TextField', [], {'blank': 'True', 'null': 'True', 'max_length': '10000'}),
        ...
        'KFLProduct.userprofile': {
            ...
            'last_viewed_product': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'to': "orm['KFLProduct.DVDProduct']", 'null': 'True', 'related_name': "'v_product'", 'symmetrical': 'False'}),
            'purchased_product': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'to': "orm['KFLProduct.DVDProduct']", 'null': 'True', 'related_name': "'p_product'", 'symmetrical': 'False'}),
