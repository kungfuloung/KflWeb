...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'KFLProduct.userprofile': {
            ...
            'last_viewed_product': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'blank': 'True', 'to': "orm['KFLProduct.DVDProduct']", 'related_name': "'v_product'", 'null': 'True'}),
            'purchased_product': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'blank': 'True', 'to': "orm['KFLProduct.DVDProduct']", 'related_name': "'p_product'", 'null': 'True'}),
