...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'downloadProduct.name'
        db.alter_column('KFLProduct_downloadproduct', 'name', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))

    def backwards(self, orm):

        # Changing field 'downloadProduct.name'
        db.alter_column('KFLProduct_downloadproduct', 'name', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
    ...
    models = {
        ...
        'KFLProduct.productbundle': {
            ...
            'category': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'to': "orm['KFLProduct.ProductCategory']", 'null': 'True', 'symmetrical': 'False'}),
            'discription_CN': ('django.db.models.fields.TextField', [], {'blank': 'True', 'max_length': '10000', 'null': 'True'}),
            'discription_EN': ('django.db.models.fields.TextField', [], {'blank': 'True', 'max_length': '10000', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'to': "orm['KFLProduct.Language']", 'null': 'True', 'symmetrical': 'False'}),
            ...
            'price': ('django.db.models.fields.FloatField', [], {'blank': 'True', 'null': 'True'}),
            'product_image': ('django.db.models.fields.files.ImageField', [], {'blank': 'True', 'max_length': '100'}),
            'products': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'to': "orm['KFLProduct.DVDProduct']", 'null': 'True', 'symmetrical': 'False'}),
            'taobao_link': ('django.db.models.fields.URLField', [], {'blank': 'True', 'max_length': '200', 'null': 'True'}),
            'title_CN': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '30', 'null': 'True'}),
            'title_EN': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '30', 'null': 'True'})
        },
        ...
        'KFLProduct.userprofile': {
            ...
            'last_viewed_product': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'to': "orm['KFLProduct.DVDProduct']", 'related_name': "'v_product'", 'null': 'True', 'symmetrical': 'False'}),
            'purchased_product': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'to': "orm['KFLProduct.DVDProduct']", 'related_name': "'p_product'", 'null': 'True', 'symmetrical': 'False'}),
