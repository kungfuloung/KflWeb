...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoTutorial.minute'
        db.add_column('Tutorial_videotutorial', 'minute',
                      self.gf('django.db.models.fields.IntegerField')(blank=True, null=True),
                      keep_default=False)

        # Adding field 'VideoTutorial.second'
        db.add_column('Tutorial_videotutorial', 'second',
                      self.gf('django.db.models.fields.IntegerField')(blank=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VideoTutorial.minute'
        db.delete_column('Tutorial_videotutorial', 'minute')

        # Deleting field 'VideoTutorial.second'
        db.delete_column('Tutorial_videotutorial', 'second')
    ...
    models = {
        ...
        'KFLProduct.dvdproduct': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['KFLProduct.Language']", 'blank': 'True', 'null': 'True'}),
        ...
        'KFLProduct.userprofile': {
            ...
            'last_viewed_product': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'v_product'", 'to': "orm['KFLProduct.DVDProduct']", 'symmetrical': 'False', 'blank': 'True', 'null': 'True'}),
            'purchased_product': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'p_product'", 'to': "orm['KFLProduct.DVDProduct']", 'symmetrical': 'False', 'blank': 'True', 'null': 'True'}),
        ...
        'Tutorial.videotutorial': {
            ...
            'second': ('django.db.models.fields.IntegerField', [], {'blank': 'True', 'null': 'True'}),
            'topic_CN': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True', 'null': 'True'}),
            'topic_EN': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True', 'null': 'True'}),
            'youku_link': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True', 'null': 'True'}),
            'youtube_link': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True', 'null': 'True'})
        },
        'auth.group': {
